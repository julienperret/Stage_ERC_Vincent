...
print('Population à loger d\'ici à ' + str(finalYear) + ' : ' + str(sumPopALoger))
...
poids.to_csv('output/coef.csv', index=0, columns=['raster', 'coef'])
del poids
dicCoef = {row[0]: row[1] for _, row in pd.read_csv('output/coef.csv').iterrows()}
